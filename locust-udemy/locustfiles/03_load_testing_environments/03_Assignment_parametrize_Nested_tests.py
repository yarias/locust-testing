...
"""
Get user credentials from a CSV file, read it from parent class and access them inside child task class using .parent method
"""
...
class UserBehaviour(TaskSet):
    ...
    def on_start(self):
        self.userName = ""
        self.Password = ""
        my_user = self.parent.my_user_data.pop() # Get CSV data from the parent class (MyUser)
...
class MyUser(HttpUser):
    ...
    my_user_data=CSVReader.read("data/credential_csv.csv")
    print(my_user_data)
