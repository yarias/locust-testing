from locust import HttpLocust, TaskSequence, seq_task, TaskSet,between
import re
...
class AgentLookUp(TaskSequence):
...
class AutoQuote(TaskSequence):
    ...
    def getinstantquote_3(self):
        with self.client.post("/InsuranceWebExtJS/quote_auto3.jsf", headers=header, data={"autoquote": "autoquote",
            ...
            if "Your Instant Quote in" not in self.res6.text:
