...
# Read credentials from a CSV files
my_reader=CSVReader("/Users/yermi/own/own_repos/locust-udemy/data/credential_csv.csv").read_data()
...
"""
Example of how to use a CVS files to extract the user credentials and then use them inside the user class to login
"""
...
class UserBehaviour(SequentialTaskSet):
    ...
    def on_start(self):
        ...
        self.userName = random.choice(my_reader)['UserName'] # select user randomly for example purposes
